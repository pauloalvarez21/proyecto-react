...
const Alliances = () => {
    return (_jsxs("section", { className: "alliances", children: [_jsx("h2", { children: "Alianzas" }), _jsx("div", { className: "alliances-logos", children: logos.map((logo) => (_jsx("img", { src: logo.img, alt: `aliado-${logo.label}` }, logo.label))) })] }));
};
